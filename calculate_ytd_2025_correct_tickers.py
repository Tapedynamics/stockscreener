#!/usr/bin/env python3
"""
Calculate YTD 2025 performance using the SAME tickers from 2024 baseline
"""
...
# Same 15 tickers from 2024 baseline
tickers = ['NXT', 'JBHT', 'SCCO', 'MU', 'NEE', 'AMAT', 'CXT', 'CAT',
           'AES', 'XEL', 'ELAN', 'SR', 'ESAB', 'TXRH', 'JNJ']

print("\n" + "="*70)
print("PORTFOLIO PERFORMANCE YTD 2025 - Same Tickers from 2024")
print("="*70)
print(f"\nPortfolio: {len(tickers)} stocks")
print(f"Period: January 1, 2025 to {datetime.now().strftime('%B %d, %Y')}")
print("\nTickers:")
